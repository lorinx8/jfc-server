...
const (
	...
	CMD_REPORT_ONE_ANGLE_RESULT          byte = 12
	CMD_REPORT_ONE_ANGLE_RESULT_RESPONSE byte = 13
	CMD_ONE_ANGLE_RESULT_NO_NEED_CROP    byte = 0
	CMD_ONE_ANGLE_RESULT_NEED_CROP       byte = 1

	CMD_REPORT_CROP_IMAGE          byte = 14 // 上报截图
	CMD_REPORT_CROP_IMAGE_RESPONSE byte = 15 // 上报截图的反馈
